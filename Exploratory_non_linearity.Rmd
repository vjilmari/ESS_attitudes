...
EX9.plot.dat$party<-ifelse(EX9.plot.dat$anti.imm.party.dummy==1,"Anti-immigration voters",
                           ifelse(EX9.plot.dat$pro.env.party.dummy==1,"Pro-environmental voters",
...
#ggsave(plot = non.lin.plot,
#       filename="non.lin.plot.pdf",device = "pdf",
#       units = "cm",width=12,height=18,dpi = 600)


#ggsave(plot = non.lin.plot,
#       filename="non.lin.plot.eps",device = "eps",
#       units = "cm",width=12,height=18,dpi = 600)

ggsave(plot = non.lin.plot,
       filename="non.lin.plot.tiff",device = "tiff",
       units = "cm",width=12,height=18,dpi = 600)
